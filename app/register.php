     ...
     <div id="header">
		...
		<div id="reg_content">
        	<div style="width:684px; margin:auto;">
                    ...
                    <div class="content_reg_line"><span style="font-size:14px;"><strong><font color="#FF0000"></font>用户注册</strong></span></div>
...
<!--                     <div class="content_reg_line">
					...
					<button class="button button-highlight button-box button-large" style="float: left;"><i class="fa fa-plus"></i>确 定</button>
