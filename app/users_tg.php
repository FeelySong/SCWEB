...
<HEAD><TITLE><?php echo $webname;?>  - 推广链接</TITLE>
...
<SPAN class="action-span zhuangtai"><A href="users_tg.php" target='mainframe'>推广链接</a></SPAN>
...
<SPAN class="action-span1"><DIV class='icons_mb1'></DIV>当前位置: <A href="/" target='_top'><?php echo $webname;?></a>
 - 推广链接 </SPAN><DIV style="clear:both"></DIV></H1>
...
<input type="hidden" name="flag" value="update" />
  <tr>
  	<td class="nl">我的推广链接地址:</td>
    <td><?=$gourl?>/register.php?id=<?=$_SESSION["sess_uid"]?></td>
  </tr>
  <tr><td></td><td>
<script language="javascript"> 
   function copyToClipBoard(){ 
    var clipBoardContent=""; 
    clipBoardContent+="<?=$gourl?>/register.php?id=<?=$_SESSION["sess_uid"]?>"; 
    window.clipboardData.setData("Text",clipBoardContent); 
    alert("复制成功！"); 
} 
</script>	<a href="#" onClick="copyToClipBoard()" title="点击复制推广地址">复制推广地址</a></td></tr>
</form>
</table>
</div>
