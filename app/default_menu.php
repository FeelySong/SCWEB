...
<dl><dt><div class='t_header currsorauto'><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<dd>
		<ul class='t_infobox'>
            <li><span style="font-weight:bold; margin-left: 10px;"><?=$rowa['nickname']?></span></li>
			<li id='refreshimg' style="" TITLE='点击刷新余额' style="magrin-left: 10px;">余额: <span id="leftusermoney" style="color:#fdd205; font-weight:bold;"><?=number_format($lmoney,2)?></span></li>
            <?php if($total>0){?>
        ...
        <ul class='t_infobox'>
            ...
            <a href="account_autosave.php" class="button button-glow button-border button-rounded button-primary" target="mainframe" style="margin-top: 10px;margin-left: 10px;">充值</a>
            <a href="account_draw.php" class="button button-glow button-border button-rounded button-primary" target="mainframe" style="margin-top: 10px;margin-left: 10px;">提现</a>
