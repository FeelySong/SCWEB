  ...
  <tr>
	...
	<dd>
		<ul class='t_infobox'>
			...
			<li id='refreshimg' style="" TITLE='点击刷新余额'><span style="margin-left: 50px;">余额:</span><span id="leftusermoney" style="color:#fdd205; font-weight:bold;"><?=number_format($lmoney,2)?></span></li>
            <?php if($total>0){?>
