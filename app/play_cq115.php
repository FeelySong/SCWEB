...
$sqls="select * from ssc_nums where cid='11' and endtime>='".date("H:i:s")."' order by id asc limit 1";
...
//	$issue=$_REQUEST['issue'];	//120225076
	...
	$sqla="select * from ssc_data where cid='11' and issue='".ddlid($_REQUEST['issue'],11)."'";
	...
	$sqlc="select * from ssc_data where cid='11' order by issue desc limit 1";
	$rsc=mysql_query($sqlc) or  die("数据库修改出错!!".mysql_error());
	$rowc = mysql_fetch_array($rsc);
	
	$sqld = "select * from ssc_class WHERE cid='11' order by id asc";
...
<HEAD><TITLE><?php echo $webname;?>  - 开始游戏[重庆十一选五]</TITLE>
...
$(document).ready(function(){
	$.playInit({ 
		data_label: [
									<?php if($zt[341]=="1" || $zt[342]=="1"){?>
										{title:'三码',label:[<?php if($zt[341]=="1"){?>{methoddesc:'从第一位、第二位、第三位中至少各选择1个号码。',
...
code_sp  : ' ',
                                                  ...
                                                  name:'前三直选复式',
                                                  prize:{1:'<?=$rate[358][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[341]/100?>","prize":<?=$rate[358][0]?>},{"point":0,"prize":<?=floor($rate[358][0]*(1+$rebate[341]/90)*10)/10?>}]}],
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前三直选单式'
                                                }<?php if($zt[342]=="1"){echo ",";}?><?php }?><?php if($zt[342]=="1"){?>{methoddesc:'从0-9中任意选择3个或3个以上号码。',
methodhelp:'从01-11中共11个号码中选择3个号码，所选号码与当期顺序摇出的5个号码中的前3个号码相同，顺序不限，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'前三组选复式',
                                                  prize:{1:'<?=$rate[359][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[342]/100?>","prize":<?=$rate[359][0]?>},{"point":0,"prize":<?=floor($rate[359][0]*(1+$rebate[342]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前三组选复式'
                                                },{methoddesc:'手动输入号码，至少输入1个三位数号码组成一注。',
methodhelp:'手动输入3个号码组成一注，所输入的号码与当期顺序摇出的5个号码中的前3个号码相同，顺序不限，即为中奖。',
                                    ...
                                    code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前三组选单式'
                                                }<?php }?>]}<?php if($zt[343]=="1" || $zt[344]=="1" || $zt[345]=="1" || $zt[346]=="1" || $zt[347]=="1" || $zt[348]=="1" || $zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?>
									<?php }?>
									<?php if($zt[343]=="1" || $zt[344]=="1"){?>												
												{title:'二码',label:[<?php if($zt[343]=="1"){?>{methoddesc:'从第一位、第二位中至少各选择1个号码。',
...
code_sp  : ' ',
                                                  ...
                                                  name:'前二直选复式',
                                                  prize:{1:'<?=$rate[360][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[343]/100?>","prize":<?=$rate[360][0]?>},{"point":0,"prize":<?=floor($rate[360][0]*(1+$rebate[343]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前二直选复式'
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前二直选单式'
                                                }<?php if($zt[344]=="1"){echo ",";}?><?php }?><?php if($zt[344]=="1"){?>{methoddesc:'从0-9中任意选择2个或2个以上号码。',
methodhelp:'从01-11中共11个号码中选择2个号码，所选号码与当期顺序摇出的5个号码中的前2个号码相同，顺序不限，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'前二组选复式',
                                                  prize:{1:'<?=$rate[361][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[344]/100?>","prize":<?=$rate[361][0]?>},{"point":0,"prize":<?=floor($rate[361][0]*(1+$rebate[344]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前二组选复式'
                                                },{methoddesc:'手动输入号码，至少输入1个两位数号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前二组选单式'
                                                }<?php }?>]}<?php if($zt[345]=="1" || $zt[346]=="1" || $zt[347]=="1" || $zt[348]=="1" || $zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?>
									<?php }?>
									<?php if($zt[345]=="1"){?>												
...
methodhelp:'从01-11中共11个号码中选择1个号码，每注由1个号码组成，只要当期顺序摇出的第一位、第二位、第三位开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'不定位',
                                                  prize:{1:'<?=$rate[362][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[345]/100?>","prize":<?=$rate[362][0]?>},{"point":0,"prize":<?=floor($rate[362][0]*(1+$rebate[345]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'前三不定位'
                                                }]}<?php if($zt[346]=="1" || $zt[347]=="1" || $zt[348]=="1" || $zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?>
									<?php }?>
									<?php if($zt[346]=="1"){?>
...
methodhelp:'从第一位，第二位，第三位任意1个位置或多个位置上选择1个号码，所选号码与相同位置上的开奖号码一致，即为中奖。',
                                    ...
                                    code_sp : ' ',
                                                  ...
                                                  name:'定位胆',
                                                  prize:{1:'<?=$rate[363][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[346]/100?>","prize":<?=$rate[363][0]?>},{"point":0,"prize":<?=floor($rate[363][0]*(1+$rebate[346]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'定位胆'
                                                }]}<?php if($zt[347]=="1" || $zt[348]=="1" || $zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?>
									<?php }?>
									<?php if($zt[347]=="1" || $zt[348]=="1"){?>	
												{title:'趣味型',label:[<?php if($zt[347]=="1"){?>{methoddesc:'从不同的单双组合中任意选择1个或1个以上的组合。',
methodhelp:'从5种单双个数组合中选择1种组合，当期开奖号码的单双个数与所选单双组合一致，即为中奖。',
                                    ...
                                    code_sp : '|',
                                                  methodid : 366,
                                                  name:'定单双',
                                                  prize:{1:'<?=$rate[366][0]?>',2:'<?=$rate[366][1]?>',3:'<?=$rate[366][2]?>',4:'<?=$rate[366][3]?>',5:'<?=$rate[366][4]?>',6:'<?=$rate[366][5]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][0]?>},{"point":0,"prize":<?=floor($rate[366][0]*(1+$rebate[347]/90)*10)/10?>}]},{"level":2,"prize":[{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][0]?>},{"point":0,"prize":<?=floor($rate[366][0]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][1]?>},{"point":0,"prize":<?=floor($rate[366][1]*(1+$rebate[347]/90)*10)/10?>}]},{"level":3,"prize":[{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][0]?>},{"point":0,"prize":<?=floor($rate[366][0]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][1]?>},{"point":0,"prize":<?=floor($rate[366][1]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][2]?>},{"point":0,"prize":<?=floor($rate[366][2]*(1+$rebate[347]/90)*10)/10?>}]},{"level":4,"prize":[{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][0]?>},{"point":0,"prize":<?=floor($rate[366][0]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][1]?>},{"point":0,"prize":<?=floor($rate[366][1]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][2]?>},{"point":0,"prize":<?=floor($rate[366][2]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][3]?>},{"point":0,"prize":<?=floor($rate[366][3]*(1+$rebate[347]/90)*10)/10?>}]},{"level":5,"prize":[{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][0]?>},{"point":0,"prize":<?=floor($rate[366][0]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][1]?>},{"point":0,"prize":<?=floor($rate[366][1]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][2]?>},{"point":0,"prize":<?=floor($rate[366][2]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][3]?>},{"point":0,"prize":<?=floor($rate[366][3]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][4]?>},{"point":0,"prize":<?=floor($rate[366][4]*(1+$rebate[347]/90)*10)/10?>}]},{"level":6,"prize":[{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][0]?>},{"point":0,"prize":<?=floor($rate[366][0]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][1]?>},{"point":0,"prize":<?=floor($rate[366][1]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][2]?>},{"point":0,"prize":<?=floor($rate[366][2]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][3]?>},{"point":0,"prize":<?=floor($rate[366][3]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][4]?>},{"point":0,"prize":<?=floor($rate[366][4]*(1+$rebate[347]/90)*10)/10?>},{"point":"<?=$rebate[347]/100?>","prize":<?=$rate[366][5]?>},{"point":0,"prize":<?=floor($rate[366][5]*(1+$rebate[347]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'定单双'
                                                }<?php if($zt[348]=="1"){echo ",";}?><?php }?><?php if($zt[348]=="1"){?>{methoddesc:'从3-9中任意选择1个或1个以上数字。',
methodhelp:'从3-9中选择1个号码进行购买，所选号码与5个开奖号码按照大小顺序排列后的第3个号码相同，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  methodid : 367,
                                                  name:'猜中位',
                                                  prize:{1:'<?=$rate[367][0]?>',2:'<?=$rate[367][1]?>',3:'<?=$rate[367][2]?>',4:'<?=$rate[367][3]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][0]?>},{"point":0,"prize":<?=floor($rate[367][0]*(1+$rebate[348]/90)*10)/10?>}]},{"level":2,"prize":[{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][0]?>},{"point":0,"prize":<?=floor($rate[367][0]*(1+$rebate[348]/90)*10)/10?>},{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][1]?>},{"point":0,"prize":<?=floor($rate[367][1]*(1+$rebate[348]/90)*10)/10?>}]},{"level":3,"prize":[{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][0]?>},{"point":0,"prize":<?=floor($rate[367][0]*(1+$rebate[348]/90)*10)/10?>},{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][1]?>},{"point":0,"prize":<?=floor($rate[367][1]*(1+$rebate[348]/90)*10)/10?>},{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][2]?>},{"point":0,"prize":<?=floor($rate[367][2]*(1+$rebate[348]/90)*10)/10?>}]},{"level":4,"prize":[{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][0]?>},{"point":0,"prize":<?=floor($rate[367][0]*(1+$rebate[348]/90)*10)/10?>},{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][1]?>},{"point":0,"prize":<?=floor($rate[367][1]*(1+$rebate[348]/90)*10)/10?>},{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][2]?>},{"point":0,"prize":<?=floor($rate[367][2]*(1+$rebate[348]/90)*10)/10?>},{"point":"<?=$rebate[348]/100?>","prize":<?=$rate[367][3]?>},{"point":0,"prize":<?=floor($rate[367][3]*(1+$rebate[348]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'猜中位'
                                                }<?php }?>]}<?php if($zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?>
									<?php }?>
									<?php if($zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){?>												
												{title:'任选复式',label:[<?php if($zt[349]=="1"){?>{methoddesc:'从01-11中任意选择1个或1个以上号码。',
methodhelp:'从01-11共11个号码中选择1个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选一中一',
                                                  prize:{1:'<?=$rate[368][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[349]/100?>","prize":<?=$rate[368][0]?>},{"point":0,"prize":<?=floor($rate[368][0]*(1+$rebate[349]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选一中一'
                                                }<?php if($zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[350]=="1"){?>{methoddesc:'从01-11中任意选择2个或2个以上号码。',
methodhelp:'从01-11共11个号码中选择2个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选二中二',
                                                  prize:{1:'<?=$rate[369][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[350]/100?>","prize":<?=$rate[369][0]?>},{"point":0,"prize":<?=floor($rate[369][0]*(1+$rebate[350]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选二中二'
                                                }<?php if($zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[351]=="1"){?>{methoddesc:'从01-11中任意选择3个或3个以上号码。',
methodhelp:'从01-11共11个号码中选择3个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选三中三',
                                                  prize:{1:'<?=$rate[370][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[351]/100?>","prize":<?=$rate[370][0]?>},{"point":0,"prize":<?=floor($rate[370][0]*(1+$rebate[351]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选三中三'
                                                }<?php if($zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[352]=="1"){?>{methoddesc:'从01-11中任意选择4个或4个以上号码。',
methodhelp:'从01-11共11个号码中选择4个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选四中四',
                                                  prize:{1:'<?=$rate[371][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[352]/100?>","prize":<?=$rate[371][0]?>},{"point":0,"prize":<?=floor($rate[371][0]*(1+$rebate[352]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选四中四'
                                                }<?php if($zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[353]=="1"){?>{methoddesc:'从01-11中任意选择5个或5个以上号码。',
methodhelp:'从01-11共11个号码中选择5个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选五中五',
                                                  prize:{1:'<?=$rate[372][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[353]/100?>","prize":<?=$rate[372][0]?>},{"point":0,"prize":<?=floor($rate[372][0]*(1+$rebate[353]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选五中五'
                                                }<?php if($zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[354]=="1"){?>{methoddesc:'从01-11中任意选择6个或6个以上号码。',
methodhelp:'从01-11共11个号码中选择6个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选六中五',
                                                  prize:{1:'<?=$rate[373][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[354]/100?>","prize":<?=$rate[373][0]?>},{"point":0,"prize":<?=floor($rate[373][0]*(1+$rebate[354]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选六中五'
                                                }<?php if($zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[355]=="1"){?>{methoddesc:'从01-11中任意选择7个或7个以上号码。',
methodhelp:'从01-11共11个号码中选择7个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选七中五',
                                                  prize:{1:'<?=$rate[374][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[355]/100?>","prize":<?=$rate[374][0]?>},{"point":0,"prize":<?=floor($rate[374][0]*(1+$rebate[355]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选七中五'
                                                }<?php if($zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[356]=="1"){?>{methoddesc:'从01-11中任意选择8个或8个以上号码。',
methodhelp:'从01-11共11个号码中选择8个号码进行购买，只要当期顺序摇出的5个开奖号码中包含所选号码，即为中奖。',
                                    ...
                                    code_sp : ',',
                                                  ...
                                                  name:'任选八中五',
                                                  prize:{1:'<?=$rate[375][0]?>'},
                                                  dyprize:[{"level":1,"prize":[{"point":"<?=$rebate[356]/100?>","prize":<?=$rate[375][0]?>},{"point":0,"prize":<?=floor($rate[375][0]*(1+$rebate[356]/90)*10)/10?>}]}],
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选八中五'
                                                }<?php }?>]}<?php if($zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?>
									<?php }?>
									<?php if($zt[349]=="1" || $zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){?>												
												{title:'任选单式',label:[<?php if($zt[349]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入1个号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选一中一'
                                                }<?php if($zt[350]=="1" || $zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[350]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入2个号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选二中二'
                                                }<?php if($zt[351]=="1" || $zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[351]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入3个号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选三中三'
                                                }<?php if($zt[352]=="1" || $zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[352]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入4个号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选四中四'
                                                }<?php if($zt[353]=="1" || $zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[353]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入5个号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选五中五'
                                                }<?php if($zt[354]=="1" || $zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[354]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入6个号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选六中五'
                                                }<?php if($zt[355]=="1" || $zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[355]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入7个号码组成一注。',
...
code_sp : ';',
                                                  ...
                                                  modes:[{modeid:1,name:'元',rate:1},{modeid:2,name:'角',rate:0.1},{modeid:3,name:'分',rate:0.01}],
                                                  desc:'任选七中五'
                                                }<?php if($zt[356]=="1"){echo ",";}?><?php }?><?php if($zt[356]=="1"){?>{methoddesc:'手动输入号码，从01-11中任意输入8个号码组成一注。',
...
<?php
if($nums==0){
	$sqlb="select * from ssc_nums where cid='11' order by id asc";
}else{
	$sqlb="select * from ssc_nums where cid='11' and endtime>='".date("H:i:s")."' order by id asc";
}
...
?>						                               ],
		...
		lotteryid : parseInt(11,10),
		isdynamic : 1,
		//onfinishbuy: function(){window.parent.abcd();},
		ajaxurl   : './play_cq115.php'
	});
});
})(jQuery);
</SCRIPT>
                    ...
                    <div class="gm_con">
                        ...
                        <div class="gm_con_to">
                            <div class="gct_l">
                                ...
                                <div class="gct_menu">
                                    <a class="gct_menu_yl" href='history_code.php?id=11' target="_blank"></a>                                </div>
                            </div>
                            <div class="gct_r">
                                <h3>重庆十一选五  第 <b><span class=nn id="lt_gethistorycode"><?=$rowc['issue']?></span> </b> 期 
