...
<DIV ID='main_box_s2'><DIV class='icons_mb2'></DIV>当前位置: <A href="/" target='_top'>嘟嘟游戏</a> - 前三直选走势 </DIV>
...
?>			
	<tr>
		...
		<td class="wdh td0" align="center"><?php if($n3==1){echo "<div class='ball01'>1</div>";$a[23]=0;$s[23]=$s[23]+1;}else{echo "<div class='ball13'>".$a[23]."</div>";$c[23]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==2){echo "<div class='ball01'>2</div>";$a[24]=0;$s[24]=$s[24]+1;}else{echo "<div class='ball13'>".$a[24]."</div>";$c[24]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==3){echo "<div class='ball01'>3</div>";$a[25]=0;$s[25]=$s[25]+1;}else{echo "<div class='ball13'>".$a[25]."</div>";$c[25]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==4){echo "<div class='ball01'>4</div>";$a[26]=0;$s[26]=$s[26]+1;}else{echo "<div class='ball13'>".$a[26]."</div>";$c[26]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==5){echo "<div class='ball01'>5</div>";$a[27]=0;$s[27]=$s[27]+1;}else{echo "<div class='ball13'>".$a[27]."</div>";$c[27]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==6){echo "<div class='ball01'>6</div>";$a[28]=0;$s[28]=$s[28]+1;}else{echo "<div class='ball13'>".$a[28]."</div>";$c[28]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==7){echo "<div class='ball01'>7</div>";$a[29]=0;$s[29]=$s[29]+1;}else{echo "<div class='ball13'>".$a[29]."</div>";$c[29]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==8){echo "<div class='ball01'>8</div>";$a[30]=0;$s[30]=$s[30]+1;}else{echo "<div class='ball13'>".$a[30]."</div>";$c[30]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==9){echo "<div class='ball01'>9</div>";$a[31]=0;$s[31]=$s[31]+1;}else{echo "<div class='ball13'>".$a[31]."</div>";$c[31]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==10){echo "<div class='ball01'>10</div>";$a[32]=0;$s[32]=$s[32]+1;}else{echo "<div class='ball13'>".$a[32]."</div>";$c[32]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($n3==11){echo "<div class='ball01'>11</div>";$a[33]=0;$s[33]=$s[33]+1;}else{echo "<div class='ball13'>".$a[33]."</div>";$c[33]=0;}?></td>
		<td class="wdh td1" align="center"><?php if($na==3){echo "<div class='ball03'>3:0</div>";$a[34]=0;$s[34]=$s[34]+1;}else{echo "<div class='ball14'>".$a[34]."</div>";$c[34]=0;}?></td>
		<td class="wdh td1" align="center"><?php if($na==2){echo "<div class='ball03'>2:1</div>";$a[35]=0;$s[35]=$s[35]+1;}else{echo "<div class='ball14'>".$a[35]."</div>";$c[35]=0;}?></td>
		<td class="wdh td1" align="center"><?php if($na==1){echo "<div class='ball03'>1:2</div>";$a[36]=0;$s[36]=$s[36]+1;}else{echo "<div class='ball14'>".$a[36]."</div>";$c[36]=0;}?></td>
		<td class="wdh td1" align="center"><?php if($na==0){echo "<div class='ball03'>0:3</div>";$a[37]=0;$s[37]=$s[37]+1;}else{echo "<div class='ball14'>".$a[37]."</div>";$c[37]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($nb==3){echo "<div class='ball04'>3:0</div>";$a[38]=0;$s[38]=$s[38]+1;}else{echo "<div class='ball13'>".$a[38]."</div>";$c[38]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($nb==2){echo "<div class='ball04'>2:1</div>";$a[39]=0;$s[39]=$s[39]+1;}else{echo "<div class='ball13'>".$a[39]."</div>";$c[39]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($nb==1){echo "<div class='ball04'>1:2</div>";$a[40]=0;$s[40]=$s[40]+1;}else{echo "<div class='ball13'>".$a[40]."</div>";$c[40]=0;}?></td>
		<td class="wdh td0" align="center"><?php if($nb==0){echo "<div class='ball04'>0:3</div>";$a[41]=0;$s[41]=$s[41]+1;}else{echo "<div class='ball13'>".$a[41]."</div>";$c[41]=0;}?></td>
