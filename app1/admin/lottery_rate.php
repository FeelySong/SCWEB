...
if (strpos($_SESSION['admin_flag'],'81') ){}else{ 
...
if($act=="edit"){
	...
	$sql="update ssc_class set rates = '".$_POST['rate']."' where id ='".$_POST['sid']."'";
//	echo $sql;
	if (!mysql_query($sql)){
...
<div align="center"><br />
	<table width="95%" border="0" cellpadding="0" cellspacing="0" class="top_list">
      <tr>
        <td class="top_list_td icons_a8">　　您现在的位置是：奖金管理 &gt; 奖金设置</td>
      </tr>
    </table>
  	<br />
...
<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
			  ...
			  <td width="25%" class="t_list_caption">奖金</td>
			...
			<tr class="t_list_tr_<?=$i%2?>" onMouseOver="this.style.backgroundColor='#E8F1FF'" onMouseOut="this.style.backgroundColor=''">
				...
				<td align="center"><input type="text" name="rate" maxlength="100" size="40" value="<?=$row['rates']?>" onkeypress="alphaOnly(event);" onblur="this.className='inp1';" class="inp1" onfocus="this.className='inp1a'" ></td>
