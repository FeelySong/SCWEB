...
if (strpos($_SESSION['admin_flag'],'77') ){}else{ 
...
if($act=="edit"){
	...
	$sql="update ssc_class set maxzhu = '".$_POST['maxzhu']."' where id ='".$_POST['sid']."'";
//	echo $sql;
	if (!mysql_query($sql)){
...
<div align="center"><br />
	<table width="95%" border="0" cellpadding="0" cellspacing="0" class="top_list">
      <tr>
        <td class="top_list_td icons_a7">　　您现在的位置是：游戏管理 &gt; 限注管理</td>
      </tr>
    </table>
  	<br />
...
<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
			  ...
			  <td class="t_list_caption">最小注数</td>
	          <td class="t_list_caption">最大注数</td>
			...
			<tr class="t_list_tr_<?=$i%2?>" onMouseOver="this.style.backgroundColor='#E8F1FF'" onMouseOut="this.style.backgroundColor=''">
				...
				<td align="center"><input name="mimzhu" type="text" class="inp1" id="mimzhu" onfocus="this.className='inp1a'" onblur="this.className='inp1';" onkeypress="alphaOnly(event);" value="1" size="15" maxlength="15" /></td>
			    <td align="center"><input name="maxzhu" type="text" class="inp1" id="maxzhu" onfocus="this.className='inp1a'" onblur="this.className='inp1';" onkeypress="alphaOnly(event);" value="<?=$row['maxzhu']?>" size="15" maxlength="15" /></td>
