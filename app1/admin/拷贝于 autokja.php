...
//			}
		...
		}else if($mid=="32" || $mid=="33" || $mid=="34" || $mid=="35" || $mid=="36" || $mid=="70" || $mid=="108" || $mid=="109" || $mid=="110" || $mid=="111" || $mid=="112" || $mid=="146" || $mid=="147" || $mid=="148" || $mid=="149" || $mid=="150" || $mid=="176" || $mid=="177" || $mid=="178" || $mid=="306" || $mid=="307" || $mid=="308" || $mid=="334" || $mid=="335" || $mid=="336" || $mid=="337" || $mid=="338"){//定位胆ok 176时时乐 306 3d 334 p3
//			$stra=explode("|",$row['codes']);
//			$nums=0;
//			for ($i=0; $i<count($stra); $i++) {
//				$strb=explode("&",$stra[$i]);
