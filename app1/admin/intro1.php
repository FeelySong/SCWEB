...
if (strpos($_SESSION['admin_flag'],'c1') ){}else{ 
	echo "<script language=javascript>alert('对不起，您无此权限！');window.history.go(-1);</script>";
exit;}

if($_GET['act']=="edit"){
	$sql="update ssc_intro set content='".$_POST['content']."' where id='1' ";
...
<br />
	<table width="95%" border="0" cellpadding="0" cellspacing="0" class="top_list">
      <tr>
        <td class="top_list_td icons_a12">　　您现在的位置是：帮助中心 &gt; 玩法介绍</td>
      </tr>
    </table>
<br>
<form name="sonMemberForm" method="post" action="intro1.php?act=edit" onSubmit="return SubChk()">
