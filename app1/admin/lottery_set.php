...
$act=$_GET['act'];
if($act=="edit"){
	$sql="update ssc_set set lid = '".$_POST['lid']."' where id ='".$_POST['sid']."'";
//	echo $sql;
	if (!mysql_query($sql)){
  ...
  <br />
	<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
			<tr>
				...
				<td class="t_list_caption">排列序号</td>
			...
			<tr class="t_list_tr_<?=$i%2?>" onMouseOver="this.style.backgroundColor='#E8F1FF'" onMouseOut="this.style.backgroundColor=''">
				...
				<td align="center"><input name="lid" type="text" class="inp1" id="lid" onfocus="this.className='inp1a'" onblur="this.className='inp1';" onkeypress="alphaOnly(event);" value="<?=$row['lid']?>" size="10" maxlength="100" /></td>
