...
if($flag=="update"){
	...
	$_SESSION["backurl"]="users_edit.php";
	$_SESSION["backzt"]="successed";				
	$_SESSION["backname"]="更改呢称";
...
<HEAD><TITLE><?php echo $webname;?>  - 更改昵称</TITLE>
...
<H1>
<SPAN class="action-span zhuangtai"><A href="users_edit.php" target='mainframe'>更改昵称</a></SPAN>
<SPAN class="action-span"><A href="users_tg.php" target='mainframe'>推广链接</a></SPAN>
<SPAN class="action-span"><A href="users_add.php" target='mainframe'>增加用户</a></SPAN>
<SPAN class="action-span1"><DIV class='icons_mb1'></DIV>当前位置: <A href="/" target='_top'><?php echo $webname;?></a>
 - 更改昵称 </SPAN><DIV style="clear:both"></DIV></H1>
...
<input type="hidden" name="flag" value="update" />
  <tr>
  	<td class="nl">我的呢称:</td>
    <td><input type="text" size=18 name="nickname" value="<?=$nickname?>" /> ( 由 2 至 8 个字符组成,可中文 ) </td>
  </tr>
  <tr><td></td><td><button name="submit" type="submit" width='69' height='26' class="btn_submit" /></button></td></tr>
</form>
</table>
</div>
